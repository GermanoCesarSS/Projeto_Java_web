 ...
 * @author manoa
 */
@WebServlet(name = "ExcluirBrinquedo", urlPatterns = {"/ExcluirBrinquedo"})
public class ExcluirBrinquedo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            brinquedoDAO.excluir(codigobrinquedo);
            request.setAttribute("mensagem", "Brinquedo excluido com sucesso");
